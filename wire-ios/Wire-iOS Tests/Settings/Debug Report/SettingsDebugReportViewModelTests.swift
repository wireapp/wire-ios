...
class SettingsDebugReportViewModelTests: XCTestCase {
    ...
    func testShareReport() {
        ...
        mockLogsProvider.clearTemporaryDirectory_MockMethod = {}
        ...
        mockRouter.presentShareViewControllerDestinationsDebugReportOnDismiss_MockMethod = { destinations, debugReport, onDismiss in
        ...
        XCTAssertEqual(mockRouter.presentShareViewControllerDestinationsDebugReportOnDismiss_Invocations.count, 1)
        XCTAssertEqual(mockLogsProvider.clearTemporaryDirectory_Invocations.count, 1)
    }
