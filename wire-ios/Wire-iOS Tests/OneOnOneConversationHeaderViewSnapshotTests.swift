...
<<<<<<< HEAD:wire-ios/Wire-iOS Tests/UserConnectionViewSnapshotTests.swift
...
>>>>>>> d1f3870551 (fix: duplicate end to end encryption info message - WPB-24859 (#4702)):wire-ios/Wire-iOS Tests/OneOnOneConversationHeaderViewSnapshotTests.swift
