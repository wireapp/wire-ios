    ...
    internal enum Content {
      ...
      internal enum System {
        ...
        internal enum FailedtosendMessage {
          ...
          /// Message was not send as the upload was cancelled by the user.
          internal static let userCancelledUploadReason = L10n.tr("Localizable", "content.system.failedtosend_message.user_cancelled_upload_reason", fallback: "Message was not send as the upload was cancelled by the user.")
        }
