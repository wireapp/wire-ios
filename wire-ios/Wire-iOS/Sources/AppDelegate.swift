...
/*
 Failing tests:
     ...
     ConversationListViewControllerTests.testForShowingConversationsFilteredByFavourites()
     ConversationListViewControllerTests.testForShowingConversationsFilteredByGroups()
     ConversationListViewControllerTests.testForShowingConversationsFilteredByOneOnOne()
     ConversationListViewControllerTests.testForShowingConversationsWithoutAnyFilterApplied()
     ...
     EmptySearchResultsViewTests.testNoResultsForServices()
     EmptySearchResultsViewTests.testServicesNotEnabled()
     EphemeralKeyboardViewControllerTests.testThatItRendersCorrectInitially()
     GiphyConfirmationViewControllerSnapshotTests.testForInitState()
     IncomingConnectionViewTests.testThatItRendersWithFederatedUser()
     IncomingConnectionViewTests.testThatItRendersWithSecurityClassification_whenClassified()
     IncomingConnectionViewTests.testThatItRendersWithSecurityClassification_whenNotClassified()
     IncomingConnectionViewTests.testThatItRendersWithUnconnectedUser()
     IncomingConnectionViewTests.testThatItRendersWithUserName()
     IncomingConnectionViewTests.testThatItRendersWithUserName_NoHandle()
     IncomingRequestFooterTests.testIncomingRequestFooter_Dark()
     IncomingRequestFooterTests.testIncomingRequestFooter_Light()
     ...
     LandingViewControllerSnapshotTests.testForInitState()
     LandingViewControllerSnapshotTests.testForInitState()
     ProfileViewControllerTests.test_ProfileInfo_HasClientListTab_IncomingRequest()
     ProfileViewControllerTests.test_ProfileInfo_HasClientListTab_IncomingRequest_Classified()
     ProfileViewControllerTests.test_ProfileInfo_HasClientListTab_IncomingRequest_NotClassified()
     ...
     ShareContactsViewControllerSnapshotTests.testForContactsPermissionDenied()
     ShareContactsViewControllerSnapshotTests.testForInitState()
