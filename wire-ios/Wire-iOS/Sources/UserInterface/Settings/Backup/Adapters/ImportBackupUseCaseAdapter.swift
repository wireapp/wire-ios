...
struct ImportBackupUseCaseAdapter: WireBackup.ImportBackupUseCaseProtocol {
        ...
        AsyncThrowingStream { continuation in
            let task = Task<Void, Never> {
                do {
                    ...
                    continuation.finish()
//                } catch let error as WireSyncEngine.ImportLegacyBackupError { // TODO: map errors
...
/*
extension WireBackup.ImportLegacyBackupError {

    init(_ error: WireDomainPackage.ImportLegacyBackupError) {
        switch error {
