...
extension Mode {
    ...
    init(conversationType: ZMConversationType? = nil, users: [UserType]) {
...
typealias ConversationConnectAvatarViewConversation = ConversationLike & StableRandomParticipantsProvider

final class ConversationConnectAvatarView: UIView {
    struct Context {
    ...
    private var conversation: ConversationConnectAvatarViewConversation? = .none {
        didSet {
