...
final class ScreenCurtainViewController: UIViewController {
    ...
    override var shouldAutorotate: Bool {
        topmostViewController?.shouldAutorotate ?? true
    }

    override var supportedInterfaceOrientations: UIInterfaceOrientationMask {
        topmostViewController?.supportedInterfaceOrientations ?? wr_supportedInterfaceOrientations
    }
