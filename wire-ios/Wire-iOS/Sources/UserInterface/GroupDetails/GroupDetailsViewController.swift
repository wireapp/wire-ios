...
final class GroupDetailsViewController: UIViewController, ZMConversationObserver, GroupDetailsFooterViewDelegate {
    ...
    func presentParticipantsDetails(with users: [WireDataModel.UserType], selectedUsers: [WireDataModel.UserType], animated: Bool) {
...
extension GroupDetailsViewController: GroupDetailsSectionControllerDelegate, GroupOptionsSectionControllerDelegate {
    ...
    func presentFullParticipantsList(for users: [WireDataModel.UserType], in conversation: GroupDetailsConversationType) {
