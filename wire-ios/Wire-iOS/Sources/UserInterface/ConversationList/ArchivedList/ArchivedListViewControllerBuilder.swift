...
struct ArchivedListViewControllerBuilder {
    ...
    @MainActor
    func build() -> ArchivedListViewController {
    ...
    @MainActor
    private func buildKMPViewModelImplementation() -> ArchivedListViewController {
        // KMP-backed implementation will be added once Metro/Kalium exposes this screen contract.
        buildLegacy()
    }

    @MainActor
    private func buildLegacy() -> ArchivedListViewController {
