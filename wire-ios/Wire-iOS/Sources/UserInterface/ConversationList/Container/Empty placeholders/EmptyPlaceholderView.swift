...
final class EmptyPlaceholderView: UIView {
    ...
    private func setup(_ content: ConversationListViewController.EmptyPlaceholder, connectWithPeopleAction: UIAction) {
        backgroundColor = isIPadRegular() ? ColorTheme.Backgrounds.bubblesBackground : ColorTheme.Backgrounds
            .surfaceVariant
    ...
    private func createConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            arrowView.topAnchor.constraint(equalTo: topAnchor, constant: arrowOffset),
