...
struct FilterButtonStyleHelper {
    ...
    /// Configures the action image based on the image name and selection state.
    ///
    /// - Parameters:
    ///   - imageName: The name of the image.
    ///   - isSelected: A boolean indicating whether the filter is currently selected.
    /// - Returns: A configured `UIImage`.
    static func configureActionImage(named imageName: String, isSelected: Bool) -> UIImage? {
    ...
    /// Configures the attributed title based on the title and selection state.
    ///
    /// - Parameters:
    ///   - title: The title of the action.
    ///   - isSelected: A boolean indicating whether the filter is currently selected.
    /// - Returns: A configured `NSAttributedString`.
    static func configureAttributedTitle(for title: String, isSelected: Bool) -> NSAttributedString {
