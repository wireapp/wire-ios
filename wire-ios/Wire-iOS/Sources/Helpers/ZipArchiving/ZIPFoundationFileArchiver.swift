...
struct ZIPFoundationFileArchiver: FileArchiverProtocol {
    ...
    func zipResources(
        ...
        // Attempt to present <SwiftUI.PlatformAlertController: 0x11202b000> on <Wire.ZClientViewController:
        // 0x11286a600> (from <_TtGC7SwiftUI19UIHostingControllerVS_7AnyView_: 0x111832200>) while a presentation is in
        // progress.
