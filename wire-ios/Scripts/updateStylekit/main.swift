...
func getRenderingInfo(in str: String) -> [String: String] {
    let regex = try! NSRegularExpression(pattern: "@objc dynamic class func drawIcon_(\\w+)_(\\d+)pt", options: [])
...
let styleKit = URL(fileURLWithPath: "WireCommonComponents/Icons/Autogenerated/WireStyleKit.swift")
let outputURL = URL(fileURLWithPath: "WireCommonComponents/Icons/Autogenerated/StyleKitIcons.generated.swift")
