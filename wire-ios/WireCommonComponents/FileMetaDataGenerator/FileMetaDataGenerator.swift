...
public final class FileMetaDataGenerator: FileMetaDataGeneratorProtocol {
    ...
    public func metadataForFile(at url: URL) async -> ZMFileMetadata {
        ...
        let thumbnail: Data?
        do {
            thumbnail = try previewGenerator.generatePreviewForFile(at: url)
...
private extension AVAsset {
    ...
    func audioSamplesFromAsset(maxSamples: UInt64) -> [Float]? {
