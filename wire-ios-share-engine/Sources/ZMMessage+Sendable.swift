...
extension ZMMessage: Sendable {
    ...
    public func cancel() {
        ...
        let attributes: LogAttributes = [LogAttributesKey.nonce.rawValue: nonce?.safeForLoggingDescription].merging(LogAttributes.safePublic, uniquingKeysWith: { _, new in new })
