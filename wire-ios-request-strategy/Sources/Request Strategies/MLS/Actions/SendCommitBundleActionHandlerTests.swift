...
class SendCommitBundleActionHandlerTests: ActionHandlerTestBase<SendCommitBundleAction, SendCommitBundleActionHandler> {
    ...
    func test_itHandlesFailures() {
        test_itHandlesFailures([
            .failure(status: 400, error: .mlsWelcomeMismatch(message: "test"), label: "mls-welcome-mismatch"),
            .failure(
                status: 400,
            ...
            .failure(status: 403, error: .mlsMissingSenderClient(message: "test"), label: "mls-missing-sender-client"),
