...
extension ConversationRequestStrategy: ZMUpstreamTranscoder {
    ...
    public func updateUpdatedObject(
        ...
        // Note: when an other user edited the conversation name, ConversationEventProcessor is called directly as EventAsyncConsumer and a save will be done in EventProcessor
