...
final class MessageSenderTests: MessagingTestBase {
    ...
    struct Arrangement {
        ...
        init(coreDataStack: CoreDataStack) {
            ...
            featureRepository.fetchResetMLSConversations_MockValue = .init(
                status: .enabled,
        ...
        func arrange() -> (Arrangement, MessageSender) {
            (
                ...
                MessageSender(
                    ...
                    initiateResetMLSConversationUseCase: initiateResetMLSConversationUseCase as! InitiateResetMLSConversationUseCaseProtocol,
