...
extension Payload {
    struct Conversation: CodableAPIVersionAware {
        ...
        init(from decoder: Decoder, apiVersion: APIVersion) throws {
            ...
            case .v3, .v4, .v5, .v6, .v7, .v8, .v9, .v10, .v11, .v12, .v13, .v14, .v15, .v16, .v17, .v18:
            ...
            case .v5, .v6, .v7, .v8, .v9, .v10, .v11, .v12, .v13, .v14, .v15, .v16, .v17, .v18:
            ...
            switch apiVersion {
            case .v8, .v9, .v10, .v11, .v12, .v13, .v14, .v15, .v16, .v17, .v18:
...
extension Payload {
    // Only for decoding the conversation create event, which has no api version
    // associated with it.
    struct CreatedConversation: Codable, EventData {
        enum CodingKeys: String, CodingKey {
            case qualifiedID = "qualified_id"
            case id
            case type
        ...
        init(from decoder: Decoder) throws {
            ...
            // However, since the format of update events does not depend on versioning,
            // we may receive conversations from the `conversation.create` update event
            // which still have both "access_role_v2" and "access_role" fields. In this
            // case, we try to decode both.
            self.legacyAccessRole = try container.decodeIfPresent(String.self, forKey: .accessRole)
            self.accessRoles = try container.decodeIfPresent([String].self, forKey: .accessRoleV2)
