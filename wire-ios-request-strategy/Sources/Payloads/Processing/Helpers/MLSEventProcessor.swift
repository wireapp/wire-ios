...
public class MLSEventProcessor: MLSEventProcessing {
    ...
    public func process(
        ...
        await process(
            ...
            oneOnOneResolver: LegacyOneOnOneResolver(migrator: migrator, isMLSEnabled: mlsFeature.isEnabled) // note this is still used by ConversationEventProcessor (legacy processing)
        )
    }
