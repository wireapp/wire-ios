...
extension MessagingTestBase {
    ...
    func encryptedMessageToSelf(message: GenericMessage, from sender: UserClient) -> Data {
    ...
    func establishSessionFromSelf(to client: UserClient) {
    ...
    func decryptMessageFromSelf(cypherText: Data, to client: UserClient) -> Data? {
