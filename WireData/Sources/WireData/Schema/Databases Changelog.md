...
* added `senderDomain` attribute on the Message entity
* added `conversationID` attribute on the Message entity
* added `conversationDomain` attribute on the Message entity
