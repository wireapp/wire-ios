...
package enum CreationTarget: Equatable {
    case folder
    case file(WireCellsTemplate)
}

package enum WireCellsCreateUseCaseError: Error {
...
package struct WireCellsCreateUseCase: WireCellsCreateUseCaseProtocol {
    ...
    package func invoke(
        ...
        guard let url = URL(string: path) else {
            throw WireCellsCreateUseCaseError.invalidPath
        }
        ...
        guard preCheckResult == .success else {
            throw WireCellsCreateUseCaseError.alreadyExists
        }
        ...
        do {
            ...
            throw WireCellsCreateUseCaseError.serverFailedToCreate
        }
    }
