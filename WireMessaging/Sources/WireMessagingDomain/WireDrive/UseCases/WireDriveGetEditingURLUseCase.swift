...
package struct WireDriveGetEditingURLUseCase {

    private let editingURLRepository: any WireDriveEditingURLRepositoryProtocol

    package init(
        editingURLRepository: any WireDriveEditingURLRepositoryProtocol
    ) {
