...
package struct ClearPublishedDraftsUseCase: WireDriveClearPublishedDraftsUseCaseProtocol {
    ...
    public func invoke() async {
        ...
        for url in filesForDeletion {
            do {
                ...
                WireLogger.wireDrive.error("Failed to delete draft asset from disk", attributes: .safePublic)
            }
        }
    }
}
