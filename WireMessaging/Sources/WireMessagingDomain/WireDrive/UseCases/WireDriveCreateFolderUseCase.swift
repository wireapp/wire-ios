...
package enum WireDriveCreateFolderUseCaseError: Error {
    case serverFailedToCreateFolder
    case folderAlreadyExists
}

/// Creates a folder on the server.
package struct WireDriveCreateFolderUseCase: WireDriveCreateFolderUseCaseProtocol {
    ...
    package func invoke(
        ...
        guard preCheckResult == .success else {
            throw WireDriveCreateFolderUseCaseError.folderAlreadyExists
        }
        ...
        do {
            ...
            throw WireDriveCreateFolderUseCaseError.serverFailedToCreateFolder
        }
    }
