...
/// Cancels every Wire Drive direct upload that still has work left to do.
package struct WireDriveCancelDirectUploadsUseCase: WireDriveCancelDirectUploadsUseCaseProtocol {
