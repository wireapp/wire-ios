...
public enum WireDriveLocalAssetRepositoryError: Error, Equatable {

    /// The wire drive node contains no download URL for the asset.

    case missingDownloadURL

    /// The wire drive node contains no eTag for the asset.
