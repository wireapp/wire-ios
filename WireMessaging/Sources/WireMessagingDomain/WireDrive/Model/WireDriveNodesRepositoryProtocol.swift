...
package protocol WireDriveNodesRepositoryProtocol: Sendable {
    ...
    /// - Returns: The `WireDriveNode` object with the specified ID, or `nil` if not found.
    func getNode(id: UUID) async throws -> WireDriveNode?
    ...
    /// - Returns: A tuple containing an array of `WireDriveNode` objects and an optional next offset for pagination.
    func getNodes(_ request: WireDriveGetNodesRequest) async throws -> (nodes: [WireDriveNode], nextOffset: Int?)
    ...
    /// - Returns: An array of `WireDriveNodeVersion` objects representing the node’s versions.
    ...
    /// - Returns: An array of `WireDriveFileTemplate` objects representing the templates that can be created.
    func getTemplates() async throws -> [WireDriveFileTemplate]

}

package struct WireDriveGetNodesRequest: Equatable, Sendable {
