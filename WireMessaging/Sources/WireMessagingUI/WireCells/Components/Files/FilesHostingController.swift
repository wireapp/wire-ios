...
package final class FilesHostingController: UIHostingController<FilesView> {
    ...
    private func setupNavigationBar() {
        ...
        titleLabel.text = Strings.Files.navigationTitle
        ...
        closeItem.accessibilityLabel = Accessibility.Files.close
...
struct FilesHostingControllerPreview: UIViewControllerRepresentable {
    func makeUIViewController(context: Context) -> UIViewController {
        let viewModel = FilesViewModel()
        let filesHostingController = FilesHostingController(viewModel: viewModel)
        return UINavigationController(rootViewController: filesHostingController)
    }
