...
final class ShareLinkPasswordViewTests: XCTestCase {
    ...
    private var storePublicLinkPasswordUseCase: WireDriveStorePublicLinkPasswordUseCase!
    private var deletePublicLinkPasswordUseCase: WireDriveDeletePublicLinkPasswordUseCase!
