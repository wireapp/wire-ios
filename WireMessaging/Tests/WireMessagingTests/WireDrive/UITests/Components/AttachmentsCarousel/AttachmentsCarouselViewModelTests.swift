...
final class AttachmentsCarouselViewModelTests {
    ...
    func updateWhenSuccess() async throws {
        // given
        var imageDraft = WireDriveDraft.fixture(
            versionID: UUID(),
            fileType: .jpeg,
        ...
        var videoDraft = WireDriveDraft.fixture(
            versionID: UUID(),
            fileType: .mpeg4Movie,
            status: .uploading(progress: 0.5),
            name: "video.mp4",
        ...
        var audioDraft = WireDriveDraft.fixture(
            versionID: UUID(),
            fileType: .mp3,
            status: .uploading(progress: 0.5),
            name: "audio.mp3",
        ...
        var documentDraft = WireDriveDraft.fixture(
            versionID: UUID(),
