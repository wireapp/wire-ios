...
final class CreateFolderViewTests: XCTestCase {
    ...
    private var createFolderUseCase: MockWireDriveCreateFolderUseCaseProtocol!
    ...
    override func setUp() async throws {
        ...
        createFolderUseCase = MockWireDriveCreateFolderUseCaseProtocol()
    ...
    func testCreateFolderView_FolderAlreadyExistsError() async {
        let view = makeView()
        createFolderUseCase.invokeFolderPathFolderName_MockError = WireDriveCreateFolderUseCaseError
            .folderAlreadyExists
