...
final class EditFileViewModelTests {
    ...
    private let mockRepository = MockWireCellsEditingURLRepositoryProtocol()
    private lazy var useCase = WireCellsGetEditingURLUseCase(editingURLRepository: mockRepository)
