...
//! Project version number for WireExtensionComponents.
FOUNDATION_EXPORT double WireExtensionComponentsVersionNumber;

//! Project version string for WireExtensionComponents.
FOUNDATION_EXPORT const unsigned char WireExtensionComponentsVersionString[];
