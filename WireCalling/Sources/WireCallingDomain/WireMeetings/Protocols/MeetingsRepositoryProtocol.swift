...
package protocol MeetingsRepositoryProtocol: Sendable {
    ...
    func ongoingMeetings(at date: Date) -> [Meeting]
    func futureMeetings(after date: Date) -> [Meeting]
    func pastMeetings(until date: Date) -> [Meeting]

}

package final class MockMeetingsRepository: MeetingsRepositoryProtocol {
