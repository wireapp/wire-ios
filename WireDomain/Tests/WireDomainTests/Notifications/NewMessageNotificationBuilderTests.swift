...
final class NewMessageNotificationBuilderTests: XCTestCase {
    ...
    private func internalTest_assertNotificationContent(
        ...
        default:
            if isGroup {
                XCTAssertEqual(notificationContent.title, isTeam ? "\(Scaffolding.conversationName) in \(Scaffolding.teamName)": "\(Scaffolding.conversationName)")
            } else {
                XCTAssertEqual(notificationContent.title, isTeam ? "\(Scaffolding.senderName) in \(Scaffolding.teamName)": "\(Scaffolding.senderName)")
            }
        }
        ...
        switch messageContent {
        case .image:
            XCTAssertEqual(notificationContent.body, isGroup ? "\(Scaffolding.senderName) shared a picture" : "Shared a picture")
        case .asset(let asset):
            switch asset.original.metaData {
            case .image(_):
                XCTAssertEqual(notificationContent.body, isGroup ? "\(Scaffolding.senderName) shared a picture" : "Shared a picture")
            case .video(_):
                XCTAssertEqual(notificationContent.body, isGroup ? "\(Scaffolding.senderName) shared a video" : "Shared a video")
            case .audio(_):
                XCTAssertEqual(notificationContent.body, isGroup ? "\(Scaffolding.senderName) shared an audio message" : "Shared an audio message")
            default:
                XCTAssertEqual(notificationContent.body, isGroup ? "\(Scaffolding.senderName) shared a file" : "Shared a file")
            }
        ...
        case .location:
            XCTAssertEqual(notificationContent.body, isGroup ? "\(Scaffolding.senderName) shared a location" : "Shared a location")
        case .ephemeral:
        ...
        default:
            XCTAssertEqual(notificationContent.threadIdentifier, Scaffolding.conversationID.uuid.uuidString.lowercased())
        }
