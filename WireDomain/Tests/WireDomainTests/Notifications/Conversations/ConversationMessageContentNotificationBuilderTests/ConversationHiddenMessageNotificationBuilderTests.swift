...
final class ConversationHiddenMessageNotificationBuilderTests: XCTestCase {
    private var sut: ConversationHiddenMessageNotificationBuilder!
    ...
    func testGenerateHiddenMessageNotification_Is_Group_Conversation_And_Is_Team_User() async throws {
        ...
        sut = ConversationHiddenMessageNotificationBuilder(
            context: .init(
    ...
    func testGenerateHiddenMessageNotification_Is_Group_Conversation_And_Is_Personal_User() async throws {
    ...
    func testGenerateHiddenMessageNotification_Is_OneOnOne_Conversation_And_Team() async throws {
