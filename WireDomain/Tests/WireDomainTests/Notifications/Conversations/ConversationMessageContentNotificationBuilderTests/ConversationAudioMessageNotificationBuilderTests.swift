...
final class ConversationAudioMessageNotificationBuilderTests: XCTestCase {
    private var sut: ConversationAudioMessageNotificationBuilder!
    ...
    func testGenerateAudioMessageNotification_Is_Group_Conversation_And_Is_Team_User() async throws {
        ...
        sut = ConversationAudioMessageNotificationBuilder(
            context: .init(
    ...
    func testGenerateAudioMessageNotification_Is_Group_Conversation_And_Is_Personal_User() async throws {
    ...
    func testGenerateAudioMessageNotification_Is_OneOnOne_Conversation_And_Team() async throws {
    ...
    private func internalTest_assertNotificationContent(
        ...
        // Body
        if isGroup {
            XCTAssertEqual(notificationContent.body, "\(Scaffolding.senderName) shared an audio message")
        } else {
            XCTAssertEqual(notificationContent.body, "Shared an audio message")
        }
