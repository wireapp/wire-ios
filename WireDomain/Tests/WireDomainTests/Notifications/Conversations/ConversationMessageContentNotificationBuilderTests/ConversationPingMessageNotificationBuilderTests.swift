...
final class ConversationPingMessageNotificationBuilderTests: XCTestCase {
    private var sut: ConversationPingMessageNotificationBuilder!
    ...
    func testGeneratePingMessageNotification_Is_Group_Conversation_And_Is_Team_User() async throws {
        ...
        sut = ConversationPingMessageNotificationBuilder(
            context: .init(
    ...
    func testGeneratePingMessageNotification_Is_Group_Conversation_And_Is_Personal_User() async throws {
    ...
    func testGeneratePingMessageNotification_Is_OneOnOne_Conversation_And_Team() async throws {
    ...
    private func internalTest_assertNotificationContent(
        ...
        // Body
        if isGroup {
            XCTAssertEqual(notificationContent.body, "\(Scaffolding.senderName) pinged you")
        } else {
            XCTAssertEqual(notificationContent.body, "Pinged you")
        }
