...
final class ConversationFileUploadMessageNotificationBuilderTests: XCTestCase {
    private var sut: ConversationFileUploadMessageNotificationBuilder!
    ...
    func testGenerateFileUploadMessageNotification_Is_Group_Conversation_And_Is_Team_User() async throws {
        ...
        sut = ConversationFileUploadMessageNotificationBuilder(
            context: .init(
    ...
    func testGenerateFileUploadMessageNotification_Is_Group_Conversation_And_Is_Personal_User() async throws {
    ...
    func testGenerateFileUploadMessageNotification_Is_OneOnOne_Conversation_And_Team() async throws {
    ...
    private func internalTest_assertNotificationContent(
        ...
        // Body
        if isGroup {
            XCTAssertEqual(notificationContent.body, "\(Scaffolding.senderName) shared a file")
        } else {
            XCTAssertEqual(notificationContent.body, "Shared a file")
        }
