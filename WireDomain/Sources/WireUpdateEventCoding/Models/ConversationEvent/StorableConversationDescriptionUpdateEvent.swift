...
struct StorableConversationDescriptionUpdateEvent: Equatable, Codable, Sendable {
    ...
    init(_ value: WireNetwork.ConversationDescriptionUpdateEvent) {
    ...
    func toAPIModel() -> WireNetwork.ConversationDescriptionUpdateEvent {
        .init(
