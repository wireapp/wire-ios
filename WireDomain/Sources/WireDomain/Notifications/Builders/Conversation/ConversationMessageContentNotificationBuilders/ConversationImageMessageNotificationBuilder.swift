...
struct ConversationImageMessageNotificationBuilder: ConversationImageMessageNotificationBuilderProtocol {
    let context: Context
...
extension ConversationImageMessageNotificationBuilder {
    struct Context {
