...
struct ConversationVideoMessageNotificationBuilder: ConversationVideoMessageNotificationBuilderProtocol {
    let context: Context
...
extension ConversationVideoMessageNotificationBuilder {
    struct Context {
