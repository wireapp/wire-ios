...
struct ConversationAudioMessageNotificationBuilder: ConversationAudioMessageNotificationBuilderProtocol {
    let context: Context
...
extension ConversationAudioMessageNotificationBuilder {
    struct Context {
