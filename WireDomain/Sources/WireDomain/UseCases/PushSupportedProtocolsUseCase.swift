...
/// Pushes the supported protocols to the backend
...
public struct PushSupportedProtocolsUseCase: PushSupportedProtocolsUseCaseProtocol {
    ...
    public func invoke() async throws {
        let supportedProtocols = await calculateSupportedProtocolsUseCase.invoke()
        try await pushSupportedProtocolsSync.push(
