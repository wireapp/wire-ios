...
extension UserChangeInfo {
    ...
    /// observing.
    ///
    public static func add(observer: UserObserver, for user: UserType, in userSession: ZMUserSession) -> NSObjectProtocol? {
    ...
    ///
    public static func add(userObserver observer: UserObserver, in userSession: ZMUserSession) -> NSObjectProtocol {
    ...
    /// observing.
    ///
    public static func add(searchUserObserver observer: UserObserver, in userSession: ZMUserSession) -> NSObjectProtocol {
