...
extension UserChangeInfo {
    ...
    /// observing.
    ///
    public static func add(observer: UserChangeObserver, for user: UserType, in userSession: ZMUserSession) -> NSObjectProtocol? {
    ...
    ///
    public static func add(userObserver observer: UserChangeObserver, in userSession: ZMUserSession) -> NSObjectProtocol {
    ...
    /// observing.
    ///
    public static func add(searchUserObserver observer: UserChangeObserver, in userSession: ZMUserSession) -> NSObjectProtocol {
