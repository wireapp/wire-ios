...
public final class SearchUsersUseCase: SearchUsersUseCaseProtocol {
    ...
    public func invoke(
        ...
        return try await withCheckedThrowingContinuation { continuation in
            // TODO: SWIFT TASK CONTINUATION MISUSE: invoke(query:options:messageProtocol:) leaked its continuation without resuming it. This may cause tasks waiting on it to remain suspended forever.
