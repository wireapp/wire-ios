...
extension UserProfileUpdateStatus {
    ...
    /// Invoked when the handle was successfully set
    func didSetHandle() {
...
public extension UserProfileUpdateStatus {
    ...
    var currentlyChangingEmail: Bool {
    ...
    var currentlySettingEmail: Bool {
    ...
    var currentlySettingPassword: Bool {
