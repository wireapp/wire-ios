...
public class ZMUserSession: NSObject {
    ...
    public var fingerprintUseCase: GetUserClientFingerprintUseCase!
    ...
    public init(
        ...
        self.fingerprintUseCase = GetUserClientFingerprintUseCase.create(for: coreDataStack.syncContext)
