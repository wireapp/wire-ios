...
extension AddressBookTests {
    ...
    func testThatItEncodesUsers() {
        ...
        // when
        addressBook.encodeWithCompletionHandler(queue, startingContactIndex: 0, maxNumberOfContacts: 100) { chunk in
    ...
    func testThatItEncodesNoContactIfAskedToEncodePastTheLastContact() {
        ...
        // when
        addressBook.encodeWithCompletionHandler(queue, startingContactIndex: 20, maxNumberOfContacts: 20) { chunk in
