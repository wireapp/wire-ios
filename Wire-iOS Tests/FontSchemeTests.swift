...
class FontSchemeTests: XCTestCase {
    ...
    func testThatItConvertsFontToClassyNameIfFontAdjustedExtraExtraExtraLarge() {
        ...
        fixedFontNames[FontSpec(.large, .none)]     = "System-Light 29.0"
        fixedFontNames[FontSpec(.large, .medium)]   = "System-Medium 29.0"
        fixedFontNames[FontSpec(.large, .light)]    = "System-Light 29.0"
        fixedFontNames[FontSpec(.large, .thin)]     = "System-Thin 29.0"
        
        fixedFontNames[FontSpec(.normal, .none)]    = "System-Light 19.0"
        fixedFontNames[FontSpec(.normal, .light)]   = "System-Light 19.0"
        fixedFontNames[FontSpec(.normal, .thin)]    = "System-Thin 19.0"
        fixedFontNames[FontSpec(.normal, .medium)]  = "System-Medium 19.0"
        
        fixedFontNames[FontSpec(.medium, .none)]    = "System-Light 14.0"
        fixedFontNames[FontSpec(.medium, .medium)]  = "System-Medium 14.0"
        fixedFontNames[FontSpec(.medium, .regular)] = "System-Regular 14.0"
        
        fixedFontNames[FontSpec(.small, .none)]     = "System-Light 13.0"
        fixedFontNames[FontSpec(.small, .medium)]   = "System-Medium 13.0"
        fixedFontNames[FontSpec(.small, .light)]    = "System-Light 13.0"
