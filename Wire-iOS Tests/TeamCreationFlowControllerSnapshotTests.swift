...
final class TeamCreationFlowControllerSnapshotTests: ZMSnapshotTestCase {
    
    var sut: TeamCreationFlowController!
    
    override func setUp() {
        super.setUp()
        let registrationStatus = SessionManager.shared?.unauthenticatedSession?.registrationStatus
