...
@testable import WireLoggingSupport
...
struct OSLoggerCacheTests {
    ...
    @Test
    func loggerForSameTag_returnsCachedInstance() {
        let cache = OSLoggerCache(subsystem: testSubsystem)
    ...
    @Test
    func loggerForDifferentTags_createsDifferentLoggers() {
        let cache = OSLoggerCache(subsystem: testSubsystem)
    ...
    @Test
    func loggerUsesCorrectSubsystem() {
    ...
    @Test
    func concurrentAccess_isThreadSafe() async {
        let cache = OSLoggerCache(subsystem: testSubsystem)
    ...
    @Test
    func cacheWorksWithDifferentSubsystems() {
    ...
    func cacheCanUseMockLogger() {
        ...
        let mockFactory: (String, String) -> any OSLoggerProtocol = { subsystem, category in
            ...
            let logger = OSLoggerProtocolMock()
            logger.subsystem = subsystem
            logger.category = category
            return logger as any OSLoggerProtocol
        }
