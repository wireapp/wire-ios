...
class ConversationsAPIV4: ConversationsAPIV3 {
    ...
    override func getConversationGuestLink(
        ...
        return try ResponseParser()
            ...
            .failure(code: .badRequest, label: "cnv", error: ConversationsAPIError.invalidConversationID) // Dedicated error code in v4
            ...
            .failure(code: .notFound, label: "no-conversation-code", error: ConversationsAPIError.conversationCodeNotFound)
