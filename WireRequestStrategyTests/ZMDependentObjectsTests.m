...
@interface ZMDependentObjectsTests : ZMTBaseTest
...
- (void)setUp
{
    ...
    self.messageA = [ZMTextMessage insertNewObjectInManagedObjectContext:self.testSession.uiMOC];
    self.messageB = [ZMTextMessage insertNewObjectInManagedObjectContext:self.testSession.uiMOC];
    self.messageC = [ZMTextMessage insertNewObjectInManagedObjectContext:self.testSession.uiMOC];
    self.messageD = [ZMTextMessage insertNewObjectInManagedObjectContext:self.testSession.uiMOC];
}
