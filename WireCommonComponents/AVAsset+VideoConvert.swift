...
extension AVAsset {
    ...
    public static func convertAudioToUploadFormat(_ inPath: String, outPath: String, completion: ((_ success: Bool) -> Void)? = .none) {
...
extension AVURLAsset {
    ...
    public func convert(filename: String,
        ...
        unwrappedExportSession.exportVideo(exportURL: outputURL) { _, error in
