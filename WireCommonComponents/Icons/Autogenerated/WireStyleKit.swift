...
//  Wire for iOS
//
//  Created by Wire Design Team on 25.03.21.
...
public class WireStyleKit : NSObject {
    ...
    @objc dynamic public class func drawIcon_microphoneWithStrikethrough_64pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
        ...
        //// Bezier 3 Drawing
        context.saveGState()
        context.translateBy(x: 7.16, y: 2.07)
        context.scaleBy(x: 4, y: 4)

        let bezier3Path = UIBezierPath()
        bezier3Path.move(to: CGPoint(x: 6.16, y: 11.33))
        bezier3Path.addCurve(to: CGPoint(x: 4.52, y: 10.89), controlPoint1: CGPoint(x: 5.57, y: 11.33), controlPoint2: CGPoint(x: 5.03, y: 11.17))
        bezier3Path.addLine(to: CGPoint(x: 3.66, y: 11.76))
        bezier3Path.addCurve(to: CGPoint(x: 5.52, y: 12.47), controlPoint1: CGPoint(x: 4.22, y: 12.12), controlPoint2: CGPoint(x: 4.85, y: 12.37))
        bezier3Path.addLine(to: CGPoint(x: 5.52, y: 13.66))
        bezier3Path.addLine(to: CGPoint(x: 3.88, y: 13.66))
        bezier3Path.addLine(to: CGPoint(x: 3.88, y: 14.88))
        bezier3Path.addLine(to: CGPoint(x: 8.2, y: 14.88))
        bezier3Path.addLine(to: CGPoint(x: 8.2, y: 13.66))
        bezier3Path.addLine(to: CGPoint(x: 6.74, y: 13.66))
        bezier3Path.addLine(to: CGPoint(x: 6.74, y: 12.48))
        bezier3Path.addCurve(to: CGPoint(x: 11.33, y: 6.48), controlPoint1: CGPoint(x: 9.31, y: 12.14), controlPoint2: CGPoint(x: 11.33, y: 9.59))
        bezier3Path.addLine(to: CGPoint(x: 10.12, y: 6.48))
        bezier3Path.addCurve(to: CGPoint(x: 6.16, y: 11.33), controlPoint1: CGPoint(x: 10.11, y: 9.15), controlPoint2: CGPoint(x: 8.34, y: 11.33))
        bezier3Path.addLine(to: CGPoint(x: 6.16, y: 11.33))
        bezier3Path.close()
        bezier3Path.move(to: CGPoint(x: 9.03, y: 7.43))
        bezier3Path.addLine(to: CGPoint(x: 9.03, y: 6.4))
        bezier3Path.addLine(to: CGPoint(x: 5.25, y: 10.17))
        bezier3Path.addCurve(to: CGPoint(x: 6.15, y: 10.32), controlPoint1: CGPoint(x: 5.54, y: 10.26), controlPoint2: CGPoint(x: 5.83, y: 10.32))
        bezier3Path.addCurve(to: CGPoint(x: 9.03, y: 7.43), controlPoint1: CGPoint(x: 7.74, y: 10.32), controlPoint2: CGPoint(x: 9.03, y: 9.02))
        bezier3Path.close()
        bezier3Path.move(to: CGPoint(x: 10.52, y: 1.6))
        bezier3Path.addLine(to: CGPoint(x: 9.03, y: 3.09))
        bezier3Path.addLine(to: CGPoint(x: 9.03, y: 2.88))
        bezier3Path.addCurve(to: CGPoint(x: 6.15, y: 0), controlPoint1: CGPoint(x: 9.03, y: 1.29), controlPoint2: CGPoint(x: 7.74, y: 0))
        bezier3Path.addCurve(to: CGPoint(x: 3.27, y: 2.88), controlPoint1: CGPoint(x: 4.56, y: 0), controlPoint2: CGPoint(x: 3.27, y: 1.29))
        bezier3Path.addLine(to: CGPoint(x: 3.27, y: 7.43))
        bezier3Path.addCurve(to: CGPoint(x: 3.51, y: 8.59), controlPoint1: CGPoint(x: 3.27, y: 7.84), controlPoint2: CGPoint(x: 3.36, y: 8.24))
        bezier3Path.addLine(to: CGPoint(x: 2.9, y: 9.19))
        bezier3Path.addCurve(to: CGPoint(x: 2.22, y: 6.47), controlPoint1: CGPoint(x: 2.48, y: 8.42), controlPoint2: CGPoint(x: 2.22, y: 7.47))
        bezier3Path.addLine(to: CGPoint(x: 1, y: 6.47))
        bezier3Path.addCurve(to: CGPoint(x: 2.02, y: 10.07), controlPoint1: CGPoint(x: 1, y: 7.82), controlPoint2: CGPoint(x: 1.38, y: 9.06))
        bezier3Path.addLine(to: CGPoint(x: 0, y: 12.07))
        bezier3Path.addLine(to: CGPoint(x: 0.91, y: 12.99))
        bezier3Path.addLine(to: CGPoint(x: 11.44, y: 2.51))
        bezier3Path.addLine(to: CGPoint(x: 10.52, y: 1.6))
        bezier3Path.close()
        color.setFill()
        bezier3Path.fill()
    ...
    @objc dynamic public class func drawIcon_microphone_64pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
        ...
        //// Bezier 2 Drawing
        context.saveGState()
        context.translateBy(x: 11.23, y: 1.9)
        context.scaleBy(x: 4, y: 4)

        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 5.19, y: 0))
        bezier2Path.addLine(to: CGPoint(x: 5.19, y: 0))
        bezier2Path.addLine(to: CGPoint(x: 5.19, y: 0))
        bezier2Path.addLine(to: CGPoint(x: 5.34, y: 0))
        bezier2Path.addCurve(to: CGPoint(x: 7.88, y: 1.78), controlPoint1: CGPoint(x: 6.47, y: 0), controlPoint2: CGPoint(x: 7.49, y: 0.71))
        bezier2Path.addCurve(to: CGPoint(x: 8.09, y: 4.38), controlPoint1: CGPoint(x: 8.09, y: 2.46), controlPoint2: CGPoint(x: 8.09, y: 3.1))
        bezier2Path.addLine(to: CGPoint(x: 8.09, y: 6.02))
        bezier2Path.addCurve(to: CGPoint(x: 7.9, y: 8.41), controlPoint1: CGPoint(x: 8.09, y: 7.2), controlPoint2: CGPoint(x: 8.09, y: 7.84))
        bezier2Path.addLine(to: CGPoint(x: 7.88, y: 8.52))
        bezier2Path.addCurve(to: CGPoint(x: 5.34, y: 10.3), controlPoint1: CGPoint(x: 7.49, y: 9.59), controlPoint2: CGPoint(x: 6.47, y: 10.3))
        bezier2Path.addCurve(to: CGPoint(x: 5.19, y: 10.3), controlPoint1: CGPoint(x: 5.19, y: 10.3), controlPoint2: CGPoint(x: 5.19, y: 10.3))
        bezier2Path.addLine(to: CGPoint(x: 5.19, y: 10.3))
        bezier2Path.addLine(to: CGPoint(x: 5.19, y: 10.3))
        bezier2Path.addLine(to: CGPoint(x: 5.05, y: 10.3))
        bezier2Path.addCurve(to: CGPoint(x: 2.51, y: 8.52), controlPoint1: CGPoint(x: 3.91, y: 10.3), controlPoint2: CGPoint(x: 2.9, y: 9.59))
        bezier2Path.addCurve(to: CGPoint(x: 2.29, y: 5.92), controlPoint1: CGPoint(x: 2.29, y: 7.84), controlPoint2: CGPoint(x: 2.29, y: 7.2))
        bezier2Path.addLine(to: CGPoint(x: 2.29, y: 6.02))
        bezier2Path.addCurve(to: CGPoint(x: 2.48, y: 1.89), controlPoint1: CGPoint(x: 2.29, y: 3.1), controlPoint2: CGPoint(x: 2.29, y: 2.46))
        bezier2Path.addLine(to: CGPoint(x: 2.51, y: 1.78))
        bezier2Path.addCurve(to: CGPoint(x: 5.05, y: 0), controlPoint1: CGPoint(x: 2.9, y: 0.71), controlPoint2: CGPoint(x: 3.91, y: 0))
        bezier2Path.addCurve(to: CGPoint(x: 5.19, y: 0), controlPoint1: CGPoint(x: 5.19, y: 0), controlPoint2: CGPoint(x: 5.19, y: 0))
        bezier2Path.addLine(to: CGPoint(x: 5.19, y: 0))
        bezier2Path.close()
        bezier2Path.move(to: CGPoint(x: 10.39, y: 6.49))
        bezier2Path.addLine(to: CGPoint(x: 9.17, y: 6.49))
        bezier2Path.addCurve(to: CGPoint(x: 5.2, y: 11.35), controlPoint1: CGPoint(x: 9.17, y: 9.17), controlPoint2: CGPoint(x: 7.39, y: 11.35))
        bezier2Path.addCurve(to: CGPoint(x: 1.23, y: 6.49), controlPoint1: CGPoint(x: 3.01, y: 11.35), controlPoint2: CGPoint(x: 1.23, y: 9.17))
        bezier2Path.addLine(to: CGPoint(x: 0, y: 6.49))
        bezier2Path.addCurve(to: CGPoint(x: 4.55, y: 12.48), controlPoint1: CGPoint(x: 0, y: 9.58), controlPoint2: CGPoint(x: 1.99, y: 12.12))
        bezier2Path.addLine(to: CGPoint(x: 4.55, y: 13.68))
        bezier2Path.addLine(to: CGPoint(x: 2.89, y: 13.68))
        bezier2Path.addLine(to: CGPoint(x: 2.89, y: 14.89))
        bezier2Path.addLine(to: CGPoint(x: 7.24, y: 14.89))
        bezier2Path.addLine(to: CGPoint(x: 7.24, y: 13.68))
        bezier2Path.addLine(to: CGPoint(x: 5.77, y: 13.68))
        bezier2Path.addLine(to: CGPoint(x: 5.77, y: 12.49))
        bezier2Path.addCurve(to: CGPoint(x: 10.39, y: 6.49), controlPoint1: CGPoint(x: 8.36, y: 12.16), controlPoint2: CGPoint(x: 10.39, y: 9.61))
        bezier2Path.close()
        color.setFill()
        bezier2Path.fill()
    ...
    @objc dynamic public class func drawIcon_externalPartner_64pt(color: UIColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1.000)) {
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 32.04, y: 53.1))
        bezierPath.addCurve(to: CGPoint(x: 27.2, y: 57.01), controlPoint1: CGPoint(x: 30.63, y: 54.59), controlPoint2: CGPoint(x: 29.01, y: 55.91))
        bezierPath.addCurve(to: CGPoint(x: 14.9, y: 59.94), controlPoint1: CGPoint(x: 23.39, y: 59.2), controlPoint2: CGPoint(x: 19.14, y: 60.21))
        bezierPath.addCurve(to: CGPoint(x: 0.01, y: 52.52), controlPoint1: CGPoint(x: 9.14, y: 59.57), controlPoint2: CGPoint(x: 3.83, y: 56.88))
        bezierPath.addLine(to: CGPoint(x: 0.01, y: 42.14))
        bezierPath.addCurve(to: CGPoint(x: 2.07, y: 40.09), controlPoint1: CGPoint(x: 0.01, y: 41.01), controlPoint2: CGPoint(x: 0.93, y: 40.09))
        bezierPath.addLine(to: CGPoint(x: 29.97, y: 40.09))
        bezierPath.addCurve(to: CGPoint(x: 32.04, y: 42.14), controlPoint1: CGPoint(x: 31.11, y: 40.09), controlPoint2: CGPoint(x: 32.04, y: 41.01))
        bezierPath.addLine(to: CGPoint(x: 32.04, y: 53.1))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 16.02, y: 20.19))
        bezierPath.addCurve(to: CGPoint(x: 24.03, y: 28.15), controlPoint1: CGPoint(x: 20.44, y: 20.19), controlPoint2: CGPoint(x: 24.03, y: 23.76))
        bezierPath.addCurve(to: CGPoint(x: 16.02, y: 36.11), controlPoint1: CGPoint(x: 24.03, y: 32.55), controlPoint2: CGPoint(x: 20.44, y: 36.11))
        bezierPath.addCurve(to: CGPoint(x: 8.01, y: 28.15), controlPoint1: CGPoint(x: 11.6, y: 36.11), controlPoint2: CGPoint(x: 8.01, y: 32.55))
        bezierPath.addCurve(to: CGPoint(x: 16.02, y: 20.19), controlPoint1: CGPoint(x: 8.01, y: 23.76), controlPoint2: CGPoint(x: 11.6, y: 20.19))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 64.07, y: 36.59))
        bezierPath.addCurve(to: CGPoint(x: 59.23, y: 40.49), controlPoint1: CGPoint(x: 62.66, y: 38.08), controlPoint2: CGPoint(x: 61.04, y: 39.4))
        bezierPath.addCurve(to: CGPoint(x: 46.93, y: 43.42), controlPoint1: CGPoint(x: 55.42, y: 42.68), controlPoint2: CGPoint(x: 51.17, y: 43.69))
        bezierPath.addCurve(to: CGPoint(x: 32.04, y: 36.01), controlPoint1: CGPoint(x: 41.17, y: 43.06), controlPoint2: CGPoint(x: 35.86, y: 40.36))
        bezierPath.addLine(to: CGPoint(x: 32.04, y: 25.62))
        bezierPath.addCurve(to: CGPoint(x: 34.1, y: 23.57), controlPoint1: CGPoint(x: 32.04, y: 24.49), controlPoint2: CGPoint(x: 32.96, y: 23.57))
        bezierPath.addLine(to: CGPoint(x: 62, y: 23.57))
        bezierPath.addCurve(to: CGPoint(x: 64.07, y: 25.62), controlPoint1: CGPoint(x: 63.14, y: 23.57), controlPoint2: CGPoint(x: 64.07, y: 24.49))
        bezierPath.addLine(to: CGPoint(x: 64.07, y: 36.59))
        bezierPath.close()
        bezierPath.move(to: CGPoint(x: 48.05, y: 3.68))
        bezierPath.addCurve(to: CGPoint(x: 56.06, y: 11.64), controlPoint1: CGPoint(x: 52.47, y: 3.68), controlPoint2: CGPoint(x: 56.06, y: 7.24))
        bezierPath.addCurve(to: CGPoint(x: 48.05, y: 19.59), controlPoint1: CGPoint(x: 56.06, y: 16.03), controlPoint2: CGPoint(x: 52.47, y: 19.59))
        bezierPath.addCurve(to: CGPoint(x: 40.04, y: 11.64), controlPoint1: CGPoint(x: 43.63, y: 19.59), controlPoint2: CGPoint(x: 40.04, y: 16.03))
        bezierPath.addCurve(to: CGPoint(x: 48.05, y: 3.68), controlPoint1: CGPoint(x: 40.04, y: 7.24), controlPoint2: CGPoint(x: 43.63, y: 3.68))
        bezierPath.close()
        color.setFill()
        bezierPath.fill()
    }
