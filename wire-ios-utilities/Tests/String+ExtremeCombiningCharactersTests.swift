...
class String_ExtremeCombiningCharactersTests: XCTestCase {
    ...
    func testThatItPassesLongStringWithSomeDiacritics() {
        // GIVEN
        let string =
            "Falsches Üben von Xylophonmusik quält jeden größeren Zwerg. Zwölf Boxkämpfer jagen Viktor quer über den großen Sylter Deich. Polyfon zwitschernd aßen Mäxchens Vögel Rüben, Joghurt und Quark. Schweißgequält zündet Typograf Jakob verflixt öde Pangramme an."
    ...
    func testThatItSanitizesLongStringWithExcessiveDiacritics() {
        ...
        XCTAssertEqual(
            ...
            "Here's to the crazy ҉ones. The misfit҉s. The rebels. The troubl҉emake҉rs. The round pegs in t҉he square holes. The ones who see th҉ings differ҉ently҉. They're not fond of rules. And they have ҉no respect for the status quo. You can quote them, disagree with them, glorify or vil҉ify them. About the only thing you can't do is ig҉nore them. Bec҉ause ҉they change things. They push the human race f҉orward. And while some may see them as the cra҉zy ones, we see genius. Because the people who are crazy enough to think they can change the world,҉ are the ones who do.̳̣̪"
        )
    }
