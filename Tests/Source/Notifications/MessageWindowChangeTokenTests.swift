...
class MessageWindowChangeTokenTests : MessagingTest
{
    ...
    func createMessagesWithCount(messageCount: UInt, startEventIDMajor: UInt) -> [ZMTextMessage] {
        ...
        for i in startEventIDMajor..<(messageCount + startEventIDMajor) {
            let message = zmessaging.ZMTextMessage.insertNewObjectInManagedObjectContext(self.uiMOC)!
    ...
    func createConversationWindowWithMessages(messages: [ZMMessage], uiMoc : NSManagedObjectContext) -> ZMConversationMessageWindow {
        ...
        let conversation = zmessaging.ZMConversation.insertNewObjectInManagedObjectContext(uiMoc)!
    ...
    func testThatItNotifiesForAMessageUpdate()
    {
        ...
        let message2 = zmessaging.ZMImageMessage.insertNewObjectInManagedObjectContext(self.uiMOC)!
    ...
    func testThatItNotifiesIfThereAreConversationWindowChangesWithInsert()
    {
        ...
        let message2 = zmessaging.ZMTextMessage.insertNewObjectInManagedObjectContext(self.uiMOC)!
        message2.eventID = ZMEventID(string: "2.aabb")
        let message3 = zmessaging.ZMTextMessage.insertNewObjectInManagedObjectContext(self.uiMOC)!
    ...
    {
        // given
        let conversation = zmessaging.ZMConversation.insertNewObjectInManagedObjectContext(self.uiMOC)!
