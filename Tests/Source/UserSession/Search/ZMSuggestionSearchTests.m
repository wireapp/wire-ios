...
{
    return [[ZMSearchUser alloc] initWithName:name accentColor:ZMAccentColorSoftPink remoteID:[NSUUID createUUID] user:nil syncManagedObjectContext: self.syncMOC uiManagedObjectContext:self.uiMOC];
