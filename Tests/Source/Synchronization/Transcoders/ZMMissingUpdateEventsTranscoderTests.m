...
{
    // given
    ZMUpdateEvent *updateEvent = [ZMUpdateEvent eventFromEventStreamPayload:@{} uuid:nil];
...
- (void)testThatItAsksForTheNextNotificationIfThereIsOneAndThePreviousFetchFinished
{
    ...
    EventsWithIdentifier *firstEvents = [[EventsWithIdentifier alloc] initWithEvents:@[[ZMUpdateEvent eventFromEventStreamPayload:@{} uuid:nil]]
