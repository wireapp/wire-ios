...
@interface ZMRemoteIdentifierObjectTranscoderTests : MessagingTest
...
- (void)setUp
{
    ...
    self.sut = [[ZMRemoteIdentifierObjectSync alloc] initWithTranscoder:self.transcoder managedObjectContext:self.uiMOC];
}
