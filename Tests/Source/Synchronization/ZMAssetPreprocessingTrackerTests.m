...
@interface ZMAssetPreprocessingTrackerTests : MessagingTest

@property (nonatomic) id preprocessor;
@property (nonatomic) NSOperationQueue *imagePreprocessingQueue;
@property (nonatomic) ZMAssetPreprocessingTracker *sut;
...
@implementation ZMAssetPreprocessingTrackerTests
...
- (void)setUp {
    ...
    self.sut = [[ZMAssetPreprocessingTracker alloc] initWithManagedObjectContext:self.uiMOC
...
@implementation ZMAssetPreprocessingTrackerTests (OutstandingItems)
