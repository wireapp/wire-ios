...
- (void)testModelledRelationships;
{
    ...
    ZMConversation *conversation1 = [ZMConversation insertNewObjectInManagedObjectContext:self.context1];
    ZMConversation *conversation2 = [ZMConversation insertNewObjectInManagedObjectContext:self.context1];
    
    ZMTextMessage *message1 = [ZMTextMessage insertNewObjectInManagedObjectContext:self.context1];
    ZMTextMessage *message2 = [ZMTextMessage insertNewObjectInManagedObjectContext:self.context1];
    ZMTextMessage *message3 = [ZMTextMessage insertNewObjectInManagedObjectContext:self.context1];
    
    ZMUser *user1 = [ZMUser insertNewObjectInManagedObjectContext:self.context1];
    ZMUser *user2 = [ZMUser insertNewObjectInManagedObjectContext:self.context1];
    ZMUser *user3 = [ZMUser insertNewObjectInManagedObjectContext:self.context1];
    
    ZMConnection *connection1 = [ZMConnection insertNewObjectInManagedObjectContext:self.context1];
    ZMConnection *connection2 = [ZMConnection insertNewObjectInManagedObjectContext:self.context1];
    ...
    [self.context1 processPendingChanges];
    ...
    ZMConversation *c2Conversation1 = (id) [self.context2 existingObjectWithID:conversation1.objectID error:&error];
    XCTAssertEqualObjects(c2Conversation1.objectID, conversation1.objectID, @"Failed to read in 2nd context: %@", error);
    
    ZMConversation *c2Conversation2 = (id) [self.context2 existingObjectWithID:conversation2.objectID error:&error];
