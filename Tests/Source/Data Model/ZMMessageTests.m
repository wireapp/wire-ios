...
- (void)testThatWeCanSetAttributesOnSystemMessage
{
    ...
    for(int i = 0; i < 4; ++i)
    {
        ZMUser *user = [ZMUser insertNewObjectInManagedObjectContext:self.context1];
        NSError *error;
    ...
    ZMSystemMessage *message = [ZMSystemMessage insertNewObjectInManagedObjectContext:self.context1];
    ...
    ZMSystemMessage *message2 = (id) [self.context2 existingObjectWithID:message.objectID error:&error];
...
{
    // given
    ZMTextMessage *message = [ZMTextMessage insertNewObjectInManagedObjectContext:self.context1];
...
- (void)checkSenderForClass:(Class)aClass;
{
    ...
    ZMMessage *message = [aClass insertNewObjectInManagedObjectContext:self.context1];
    XCTAssertNotNil(message);
    message.sender = user;
    ...
    ZMMessage *message2 = (id) [self.context2 existingObjectWithID:message.objectID error:&error];
    XCTAssertNotNil(message2, @"Failed to load into other context: %@", error);
...
{
    // given
    ZMImageMessage *message = [ZMImageMessage insertNewObjectInManagedObjectContext:self.context1];
