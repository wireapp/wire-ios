...
#import "ZMConversationList+Testing.h"
...
@interface ZMConversationListDirectoryTests : MessagingTest
...
- (void)setUp
{
    ...
    [self.syncMOC performGroupedBlockAndWait:^{
        ...
        [oneToOneConv.voiceChannel updateActiveFlowParticipants:@[otherUser]];
        [oneToOneConv.mutableOtherActiveParticipants addObject:otherUser];
        [oneToOneConv.voiceChannel addCallParticipant:otherUser];
        ...
        [groupConv.voiceChannel addCallParticipant:otherUser];
...
- (void)tearDown
{
    ...
    [self.syncMOC performGroupedBlockAndWait:^{
        ZMConversation *oneToOneConv = (id)[self.syncMOC objectWithID:self.oneToOneConversationWithActiveCall.objectID];
        [oneToOneConv.voiceChannel tearDown];
        
        ZMConversation *groupConv = (id)[self.syncMOC objectWithID:self.groupConversationWithIncomingCall.objectID];
        [groupConv.voiceChannel tearDown];
    }];
