...
@interface ZMEditableUserTests : MessagingTest
...
- (void)testThatItDoesNotValidateAPhoneNumberWithLettersTheRightError
{
    ...
    XCTAssertEqualObjects(error.domain, ZMManagedObjectValidationErrorDomain);
    XCTAssertEqual(error.code, (long) ZMManagedObjectValidationErrorCodePhoneNumberContainsInvalidCharacters);
...
- (void)testThatItDoesNotValidateAShortPhoneNumberWithTheRightError
{
    ...
    XCTAssertEqualObjects(error.domain, ZMManagedObjectValidationErrorDomain);
    XCTAssertEqual(error.code, (long) ZMManagedObjectValidationErrorCodeStringTooShort);
}
...
- (void)testThatItDoesNotValidateALongPhoneNumberWithTheRightError
{
    ...
    XCTAssertFalse([user validateValue:&shortPhone forKey:@"phoneNumber" error:&error]);
    XCTAssertEqualObjects(error.domain, ZMManagedObjectValidationErrorDomain);
    XCTAssertEqual(error.code, (long) ZMManagedObjectValidationErrorCodeStringTooLong);
}
