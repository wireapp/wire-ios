...
class InvalidGenericMessageDataRemovalTests: DiskDatabaseTest {
    ...
    func testThatItDoesNotRemoveValidGenericMessageData() throws {
        ...
        let textMessage = conversation.appendMessage(withText: "Hello world")! as! ZMClientMessage
    ...
    func testThatItDoesNotRemoveValidGenericMessageData_Asset() throws {
        // Given
        let conversation = createConversation()
        let assetMessage = conversation.appendMessage(withImageData: self.verySmallJPEGData()) as! ZMAssetClientMessage
