...
- (BOOL)createDatabaseAtSharedContainerURL:(NSURL *)sharedContainerURL accountIdentifier:(NSUUID *)accountIdentifier
{
    ...
    if(accountIdentifier == nil) {
        ...
        [[StorageStack shared] createManagedObjectContextFromLegacyStoreInContainerAt:sharedContainerURL dispatchGroup:self.dispatchGroup startedMigrationCallback:nil completionHandler:^(ManagedObjectContextDirectory * directory) {
        ...
        [[StorageStack shared] createManagedObjectContextDirectoryForAccountWith:accountIdentifier inContainerAt:sharedContainerURL dispatchGroup:self.dispatchGroup startedMigrationCallback:nil completionHandler:^(ManagedObjectContextDirectory * directory) {
            self.contextDirectory = directory;
        }];
    }
