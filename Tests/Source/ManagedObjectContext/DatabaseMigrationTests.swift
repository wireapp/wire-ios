...
class DatabaseMigrationTests: DatabaseBaseTest {
    ...
    func testThatItPerformsMigrationFrom_Between_2_24_1_and_2_50_0_ToCurrentModelVersion() {
        ...
        ["2-24-1", "2-25-0", "2-26-0", "2-27-0", "2-28-0", "2-29-0", "2-30-0", "2-31-0", "2-39-0", "2-40-0", "2-41-0", "2-42-0", "2-43-0", "2-44-0", "2-45-0", "2-46-0", "2-47-0", "2-48-0", "2-49-0", "2-50-0", "2-51-0", "2-52-0"].forEach { storeFile in
            // GIVEN
            self.createDatabaseWithOlderModelVersion(versionName: storeFile)
