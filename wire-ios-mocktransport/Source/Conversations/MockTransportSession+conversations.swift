...
extension MockTransportSession {
    ...
    public func processReceiptModeUpdate(
    ...
    public func processAccessModeUpdate(
        for conversationId: String,
        payload: [String: AnyHashable],
        apiVersion: APIVersion
    ) -> ZMTransportResponse {
    ...
    public func processGuestLinkFeatureStatusForConversation(
        for conversationId: String,
        apiVersion: APIVersion
    ) -> ZMTransportResponse {
        guard let conversation = fetchConversation(with: conversationId) else {
    ...
    public func processJoinConversation(
        with payload: [String: AnyHashable],
        apiVersion: APIVersion
    ) -> ZMTransportResponse {
    ...
    public func processFetchConversationIdAndName(
    ...
    @objc
    public func processAddOTRMessage(
