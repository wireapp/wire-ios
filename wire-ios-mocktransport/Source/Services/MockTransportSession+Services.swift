...
public extension MockTransportSession {
    ...
    internal func fetchWhitelistedServicesForTeam(
    ...
    func processServicesProvidersRequest(_ request: ZMTransportRequest) -> ZMTransportResponse {
        guard
    ...
    internal func processServiceByIdRequest(
        provider: String,
        service: String,
        apiVersion: APIVersion
    ) -> ZMTransportResponse {
    ...
    internal func processProviderByIdRequest(provider: String, apiVersion: APIVersion) -> ZMTransportResponse {
    ...
    func processServiceRequest(_ request: ZMTransportRequest) -> ZMTransportResponse {
    ...
    func processDeleteBotRequest(_ request: ZMTransportRequest) -> ZMTransportResponse {
    ...
    func insertService(name: String, identifier: String, provider: String) -> MockService {
