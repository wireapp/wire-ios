...
/**
 * A credential that needs to be verified; either a phone number or an e-mail address.
 */

public enum UnverifiedCredential: Equatable {
    ...
    /// The raw value representing the credential provided by the user.
