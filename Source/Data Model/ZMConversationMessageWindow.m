...
static inline void ZMTraceUserInterfaceMessageWindow(ZMConversationMessageWindow *window, ZMMessageWindowEvent e)
{
    if (SYNCENGINE_UI_MESSAGE_WINDOW_NOTIFICATION_ENABLED()) {
        SYNCENGINE_UI_MESSAGE_WINDOW_NOTIFICATION((intptr_t) (__bridge void *) window, (intptr_t) (__bridge void *) window.conversation, (int) e);
    }
}
