...
/// @param preexistingRelevantMessages is a mapping from message nonce to message, that will contain a message
///     with the same nonce and in the same conversation as the message currently being parsed, if any
