...
+ (BOOL)doesEventTypeGenerateMessage:(ZMUpdateEventType)eventType
{
    return
        (eventType == ZMUpdateEventConversationAssetAdd) ||
        (eventType == ZMUpdateEventConversationMessageAdd) ||
        (eventType == ZMUpdateEventConversationClientMessageAdd) ||
        (eventType == ZMUpdateEventConversationOtrMessageAdd) ||
        (eventType == ZMUpdateEventConversationOtrAssetAdd) ||
        (eventType == ZMUpdateEventConversationKnock) ||
        [ZMSystemMessage doesEventTypeGenerateSystemMessage:eventType];
}
