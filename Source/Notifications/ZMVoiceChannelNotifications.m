...
+ (id<ZMVoiceChannelStateObserverOpaqueToken>)addGlobalVoiceChannelStateObserver:(id<ZMVoiceChannelStateObserver>)observer inUserSession:(ZMUserSession *)userSession;
{
    ...
    return (id) [userSession.managedObjectContext.globalManagedObjectContextObserver addGlobalVoiceChannelObserver:observer];
}
...
{
    [userSession.managedObjectContext.globalManagedObjectContextObserver removeGlobalVoiceChannelStateObserverForToken:token];
}
