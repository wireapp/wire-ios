...
/// Joining a channel will leave any other channel that is currently joined.
- (void)join;

/// The channel will be left automatically when another channel is joined.
- (void)leave;
...
/// Ignore the incoming call, if any
