...
extension ZMConversation {
    ...
    public var callDeviceIsActive: Bool {
        ...
        set {
            ...
            self.traceIsCallDeviceActive(newValue)
        }
    }
    ...
    public var isFlowActive: Bool {
        ...
        set {
            ...
            self.traceIsFlowActive(newValue)
        }
    }
    ...
    var hasLocalModificationsForIsVideoCall: Bool {
    ...
    public var isVideoCall: Bool {
        ...
        set {
            ...
            if let managedObjectContext = self.managedObjectContext,
                voiceChannel = self.voiceChannel where managedObjectContext.zm_isSyncContext {
                voiceChannel.updateForStateChange()
            }
        }
    }
...
@objc
public class ZMCallState : NSObject, SequenceType, CustomDebugStringConvertible {
...
public class ZMConversationCallState : NSObject, CustomDebugStringConvertible {
