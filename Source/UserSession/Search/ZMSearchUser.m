...
- (instancetype)initWithUser:(ZMUser *)user userSession:(ZMUserSession *)userSession globalCommonConnections:(NSOrderedSet <ZMUser *> *)connections cachedCommonConnections:(ZMSuggestedUserCommonConnections *)cachedCommonConnections
{
...
- (instancetype)initWithPayload:(NSDictionary *)payload userSession:(ZMUserSession *)userSession globalCommonConnections:(NSOrderedSet <ZMUser *> *)connections
{
