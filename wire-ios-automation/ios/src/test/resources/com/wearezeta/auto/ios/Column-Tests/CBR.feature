Feature: CBR
  ...
  @TC-4890 @col1 @cbr @SF.Calls @TSFI.RESTfulAPI @TSFI.Callkit @S0.4 @S3 @S4 @S5 @BundSecurity
  ...
  @TC-4888 @col1 @cbr @SF.Calls @TSFI.RESTfulAPI @TSFI.Callkit @S0.4 @S3 @S4 @S5 @BundSecurity
  ...
  @TC-4887 @TC-4891 @col1 @cbr @SF.Calls @TSFI.RESTfulAPI @TSFI.Callkit @S0.4 @S3 @S4 @S5 @BundSecurity
