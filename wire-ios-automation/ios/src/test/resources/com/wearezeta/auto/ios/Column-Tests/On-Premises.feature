Feature: On-Premises
  ...
  @TC-4997 @onpremise @col1 @col3 @SF.Channel @TSFI.UserInterface @S0.1 @Security @shouldbeui
  ...
  @TC-4998 @onpremise @col1 @col3 @SF.Locking @TSFI.UserInterface @S0.1 @Security
  ...
  @TC-4999 @SF.IOS-VSNFDAREA @TSFI.UserInterface @S0.1 @col1 @Security
