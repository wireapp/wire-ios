Feature: Search
  ...
  @TC-5001 @SF.Usersearch @TSFI.UserInterface @S0.1 @col1 @BundSecurity
  ...
  @TC-5002 @SF.Usersearch @TSFI.UserInterface @S0.1 @col1 @BundSecurity
  ...
  @TC-5003 @SF.Usersearch @TSFI.UserInterface @S0.1 @col1 @BundSecurity
  ...
  @TC-5004 @SF.Usersearch @TSFI.UserInterface @S0.1 @S7 @col1 @BundSecurity
  ...
  @TC-5005 @SF.Usersearch @TSFI.UserInterface @S0.1 @S7 @col1 @BundSecurity
  ...
  @TC-5007 @SF.Usersearch @TSFI.UserInterface @S0.1 @S7 @col1 @BundSecurity
