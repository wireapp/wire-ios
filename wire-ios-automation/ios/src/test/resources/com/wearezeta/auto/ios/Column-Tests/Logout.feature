Feature: Log Out
  ...
  @TC-6258 @logout @col1 @SF.Provisioning @TSFI.UserInterface @TSFI.RESTfulAPI @S0.1 @S2 @Security
  ...
  @TC-6091 @logout @col1 @SF.Provisioning @TSFI.UserInterface @TSFI.RESTfulAPI @S0.1 @S2 @Security
