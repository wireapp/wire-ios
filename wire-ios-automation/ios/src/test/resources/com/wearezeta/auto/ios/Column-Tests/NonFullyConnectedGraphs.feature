...
#  C1305778 I want to see an alert modal when I try to create a group with users from column 1 and bund-external as a column 3 user
...
# C1305776	I should not be able to add a bund-external user to a group with column 1 users on column 3
    ...
    And I tap Add Participants button on Group Add People page
    And I tap X button on Group Details page
#  C1305779	I want to see a system message when I try to add bund-external user to a group with users from column 1 as a column 3 user
...
#    I want to add a bund-external user to a conversation that previously had a column 1 user participating
    When I navigate back to conversations list
    And I open conversation "<GroupCol1>" in conversation list
