Feature: Federation Classified
  ...
  @TC-4941 @col1 @SF.VSNFDLABEL @TSFI.UserInterface @TSFI.Federate @S0.1 @S7 @BundSecurity
  ...
  @TC-4942 @col1 @col3 @SF.VSNFDLABEL @TSFI.UserInterface @TSFI.Federate @S0.1 @S7 @BundSecurity
  ...
  @TC-4980 @col1 @SF.VSNFDLABEL @TSFI.UserInterface @TSFI.Federate @S0.1 @S7 @BundSecurity
  ...
  @TC-4946 @col1 @SF.VSNFDLABEL @TSFI.UserInterface @TSFI.Federate @S0.1 @S7 @BundSecurity
