...
public class Config {
    ...
    public String getJenkinsSuperUserLogin(Class<?> c) {
        return getValue(c, "jenkinsSuLogin");
    }

    public String getCallingServiceUrl(Class<?> c) {
        String callingServiceUrl = getValue(c, "callingServiceUrl");
        switch (callingServiceUrl) {
            case "loadbalanced":
                return "http://192.168.2.25:80";
            case "c1":
                return "http://192.168.2.13:8080";
            case "c2":
                return "http://192.168.2.25:8080";
            case "c3":
                return "http://192.168.2.19:8080";
            case "c4":
                return "http://192.168.2.18:8080";
            case "cdev":
                return "http://192.168.2.170:8080";
            default:
