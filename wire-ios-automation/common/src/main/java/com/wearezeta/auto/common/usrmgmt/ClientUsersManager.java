...
public class ClientUsersManager {
    ...
    public static final Function<Integer, String> FIRSTNAME_ALIAS_TEMPLATE = idx -> String
    ...
    public static final Function<Integer, String> UNIQUE_USERNAME_ALIAS_TEMPLATE = idx ->
