...
public extension NSManagedObjectContext {
    ...
    func setPersistentStoreMetadata(_ data: SwiftPersistableInMetadata?, key: String) {
        setPersistentStoreMetadata(data: data, key: key)
    }

    func setPersistentStoreMetadata(array: [some SwiftPersistableInMetadata], key: String) {
