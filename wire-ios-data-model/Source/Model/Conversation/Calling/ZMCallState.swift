...
public extension NSManagedObjectContext {
    ...
    @objc var zm_callState: ZMCallState {
    ...
    @objc var zm_hasUserInfoChanges: Bool {
        get {
    ...
    @objc var zm_hasChanges: Bool {
        hasChanges || zm_hasUserInfoChanges
    }

    @objc
    func mergeCallStateChanges(fromUserInfo userInfo: [String: Any]) {
...
public extension ZMConversation {
    ...
    @objc var isCallDeviceActive: Bool {
        get {
...
public extension ZMCallState {

    /// returns true if one of the merged states changed due to the merge
    func mergeChangesFromState(_ other: ZMCallState?) -> Set<NSManagedObjectID> {
        if let other {
