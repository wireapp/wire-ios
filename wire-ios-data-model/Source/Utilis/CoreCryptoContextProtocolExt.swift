...
public protocol CoreCryptoContextProtocol : AnyObject, Sendable {
     ...
     */
    func addClientsToConversation(conversationId: WireCoreCryptoUniffi.ConversationId, keyPackages: [WireCoreCryptoUniffi.KeyPackage]) async throws -> [String]?

    /**
     * See [core_crypto::transaction_context::TransactionContext::get_or_create_client_keypackages]
     */
    func clientKeypackages(ciphersuite: WireCoreCryptoUniffi.Ciphersuite, credentialType: WireCoreCryptoUniffi.CredentialType, amountRequested: UInt32) async throws -> [WireCoreCryptoUniffi.KeyPackage]

    /**
     * See [core_crypto::transaction_context::TransactionContext::client_public_key]
     */
    func clientPublicKey(ciphersuite: WireCoreCryptoUniffi.Ciphersuite, credentialType: WireCoreCryptoUniffi.CredentialType) async throws -> Data

    /**
     * See [core_crypto::transaction_context::TransactionContext::client_valid_key_packages_count]
     */
    func clientValidKeypackagesCount(ciphersuite: WireCoreCryptoUniffi.Ciphersuite, credentialType: WireCoreCryptoUniffi.CredentialType) async throws -> UInt64
     ...
     */
    func conversationCiphersuite(conversationId: WireCoreCryptoUniffi.ConversationId) async throws -> WireCoreCryptoUniffi.Ciphersuite
     ...
     */
    func createConversation(conversationId: WireCoreCryptoUniffi.ConversationId, creatorCredentialType: WireCoreCryptoUniffi.CredentialType, config: WireCoreCryptoUniffi.ConversationConfiguration) async throws

    /**
     * See [core_crypto::mls::conversation::ConversationGuard::decrypt_message]
     */
    func decryptMessage(conversationId: WireCoreCryptoUniffi.ConversationId, payload: Data) async throws -> WireCoreCryptoUniffi.DecryptedMessage
     ...
     */
    func e2eiConversationState(conversationId: WireCoreCryptoUniffi.ConversationId) async throws -> WireCoreCryptoUniffi.E2eiConversationState
     ...
     */
    func e2eiMlsInitOnly(enrollment: WireCoreCryptoUniffi.E2eiEnrollment, certificateChain: String, nbKeyPackage: UInt32?) async throws -> [String]?
     ...
     */
    func exportSecretKey(conversationId: WireCoreCryptoUniffi.ConversationId, keyLength: UInt32) async throws -> WireCoreCryptoUniffi.SecretKey

    /**
     * See [core_crypto::mls::conversation::Conversation::get_client_ids]
     */
    func getClientIds(conversationId: WireCoreCryptoUniffi.ConversationId) async throws -> [WireCoreCryptoUniffi.ClientId]
     ...
     */
    func getDeviceIdentities(conversationId: WireCoreCryptoUniffi.ConversationId, deviceIds: [WireCoreCryptoUniffi.ClientId]) async throws -> [WireCoreCryptoUniffi.WireIdentity]

    /**
     * See [core_crypto::mls::conversation::Conversation::get_external_sender]
     */
    func getExternalSender(conversationId: WireCoreCryptoUniffi.ConversationId) async throws -> WireCoreCryptoUniffi.ExternalSenderKey

    /**
     * See [core_crypto::mls::conversation::Conversation::get_user_identities]
     */
    func getUserIdentities(conversationId: WireCoreCryptoUniffi.ConversationId, userIds: [String]) async throws -> [String : [WireCoreCryptoUniffi.WireIdentity]]

    /**
     * See [core_crypto::transaction_context::TransactionContext::join_by_external_commit]
     */
    func joinByExternalCommit(groupInfo: WireCoreCryptoUniffi.GroupInfo, customConfiguration: WireCoreCryptoUniffi.CustomConfiguration, credentialType: WireCoreCryptoUniffi.CredentialType) async throws -> WireCoreCryptoUniffi.WelcomeBundle

    /**
     * See [core_crypto::mls::conversation::ConversationGuard::mark_as_child_of]
     */
    func markConversationAsChildOf(childId: WireCoreCryptoUniffi.ConversationId, parentId: WireCoreCryptoUniffi.ConversationId) async throws

    /**
     * See [core_crypto::transaction_context::TransactionContext::mls_init]
     */
    func mlsInit(clientId: WireCoreCryptoUniffi.ClientId, ciphersuites: [WireCoreCryptoUniffi.Ciphersuite], nbKeyPackage: UInt32?) async throws

    /**
     * See [core_crypto::transaction_context::TransactionContext::process_raw_welcome_message]
     */
    func processWelcomeMessage(welcomeMessage: WireCoreCryptoUniffi.Welcome, customConfiguration: WireCoreCryptoUniffi.CustomConfiguration) async throws -> WireCoreCryptoUniffi.WelcomeBundle
     ...
     */
    func removeClientsFromConversation(conversationId: WireCoreCryptoUniffi.ConversationId, clients: [WireCoreCryptoUniffi.ClientId]) async throws

    /**
     * See [core_crypto::transaction_context::TransactionContext::save_x509_credential]
     */
    func saveX509Credential(enrollment: WireCoreCryptoUniffi.E2eiEnrollment, certificateChain: String) async throws -> [String]?
