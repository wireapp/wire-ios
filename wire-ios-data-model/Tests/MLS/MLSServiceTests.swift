...
final class MLSServiceTests: ZMConversationTestsBase, MLSServiceDelegate {
    ...
    override func setUp() {
        ...
        mockLegacyFeatureRepository.fetchAllowGlobalOperations_MockValue = Feature.AllowGlobalOperations(
            status: .enabled,
    ...
    func test_GenerateNewEpochFailsWithResetMLSConversationError_FeatureON() async throws {
        ...
        XCTAssertEqual(mockLegacyFeatureRepository.fetchAllowGlobalOperations_Invocations.count, 1)
    ...
    func test_GenerateNewEpochFailsWithResetMLSConversationError_FeatureOff() async throws {
        ...
        mockLegacyFeatureRepository.fetchAllowGlobalOperations_MockValue = Feature
