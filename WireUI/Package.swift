...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "WireIndividualToTeamMigration", dependencies: ["WireFoundation", "WireReusableUIComponents"]),
        .testTarget(name: "WireIndividualToTeamMigrationTests", dependencies: ["WireIndividualToTeamMigration"]),
