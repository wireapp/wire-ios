...
class ConversationsAPIV15: ConversationsAPIV14 {
    ...
    override func createGroupConversation(
        ...
        // New payload in v15.
        let input = CreateGroupConversationParametersV15(from: parameters)
        ...
        do {
            return try ResponseParser()
                // New payload in v15.
                .success(code: .created, type: ConversationV15.self)
...
struct CreateGroupConversationParametersV15: Encodable {
    let users: [UUID]?
    ...
    let conversationGroupType: ConversationGroupTypeV15 // changed in v15
    let cells: Bool
    ...
    init(from parameters: CreateGroupConversationParameters) {
        ...
        self.conversationGroupType = parameters.groupType.toV15()
...
extension ConversationGroupType {
    func toV15() -> ConversationGroupTypeV15 {
        switch self {
        case .group:
            .group
        case .channel:
...
struct ConversationV15: Decodable, ToAPIModelConvertible, DecodableConversation {
    enum CodingKeys: String, CodingKey {
        case access
        case accessRoles = "access_role"
    ...
    var groupType: ConversationGroupTypeV15? // Changed in v15.
