...
final class FeatureConfigsAPIV17: FeatureConfigsAPIV16 {
    ...
    override func getFeatureConfigs() async throws -> [FeatureConfig] {
        ...
        return try ResponseParser()
            .success(code: .ok, type: FeatureConfigsResponseAPIV17.self)
...
struct FeatureConfigsResponseAPIV17: Decodable, ToAPIModelConvertible {
    ...
    // added in v17
    let preventAdminlessGroups: FeatureWithConfig<FeatureConfigResponse.PreventAdminlessGroupsV17>
...
extension FeatureConfigResponse {
    ...
    struct PreventAdminlessGroupsV17: Decodable {
