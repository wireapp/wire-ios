...
public enum MLSCipherSuite: Sendable {
...
enum MLSCipherSuiteV0: Int, Sendable, Decodable {
...
extension MLSCipherSuiteV0: ToAPIModelConvertible {

    func toAPIModel() -> MLSCipherSuite {
        switch self {
        case .MLS_128_DHKEMX25519_AES128GCM_SHA256_Ed25519:
