                ...
                let expectedNotifications = [
                    TeamNotification.memberJoin(
                        .init(
                            ...
                            time: ISO8601DateFormatter.fractionalInternetDateTime.date(from: "2026-04-27T08:00:24.215142065Z")!
                        )
                    ),
                    TeamNotification.memberJoin(
                        .init(
                            ...
                            time: ISO8601DateFormatter.fractionalInternetDateTime.date(from: "2026-04-27T08:00:24.265610179Z")!
                        )
                    )
                ]
