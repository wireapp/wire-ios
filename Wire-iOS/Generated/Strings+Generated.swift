...
internal enum L10n {
  ...
  internal enum Localizable {
    ...
    internal enum CreatePasscode {
      ...
      internal static let infoLabel = L10n.tr("Localizable", "create_passcode.info_label", fallback: "It will be used to unlock Wire. If you forget this passcode **it can not be recovered.**")
      /// Create a passcode to unlock Wire. Please remember it, as **it can not be recovered.**
      internal static let infoLabelForcedApplock = L10n.tr("Localizable", "create_passcode.info_label_forced_applock", fallback: "Create a passcode to unlock Wire. Please remember it, as **it can not be recovered.**")
      /// Create a passcode
      internal static let titleLabel = L10n.tr("Localizable", "create_passcode.title_label", fallback: "Create a passcode")
      internal enum CreateButton {
        /// create passcode
        internal static let title = L10n.tr("Localizable", "create_passcode.create_button.title", fallback: "create passcode")
      }
    ...
    internal enum Unlock {
      ...
      internal static let wipeButton = L10n.tr("Localizable", "unlock.wipe_button", fallback: "Access as new device")
    ...
    internal enum WipeDatabase {
      ...
      internal static let infoLabel = L10n.tr("Localizable", "wipe_database.info_label", fallback: "The data stored on this device can only be accessed with your passcode.\n\nIf you have forgotten your passcode, you can delete the database to log in again as a new device.\n\nBy deleting the database, ")
      /// Access as new device
      internal static let titleLabel = L10n.tr("Localizable", "wipe_database.title_label", fallback: "Access as new device")
      internal enum Alert {
        /// Delete
        ...
        internal static let description = L10n.tr("Localizable", "wipe_database.alert.description", fallback: "Confirm database deletion")
      ...
      internal enum Button {
        ...
        internal static let title = L10n.tr("Localizable", "wipe_database.button.title", fallback: "I want to delete the database")
      }
      internal enum InfoLabel {
