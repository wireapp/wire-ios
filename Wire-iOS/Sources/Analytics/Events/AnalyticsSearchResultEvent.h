...
@interface AnalyticsSearchResultEvent : AnalyticsEvent

@property (assign, nonatomic) NSUInteger numberOfContactsAdded;
@property (assign, nonatomic) BOOL groupConversationCreated;
