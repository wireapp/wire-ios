...
extension Settings {
    ...
    @objc public func loadEnabledLogs() {
        ...
        let tagsToEnable = UserDefaults.shared().value(forKey: enabledLogsKey) as? Array<String> ?? ["Network", "Dependencies", "State machine", "Pingback", "SessionManager", "ConversationListObserverCenter"]
