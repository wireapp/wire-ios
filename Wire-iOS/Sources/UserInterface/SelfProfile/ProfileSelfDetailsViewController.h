...
@protocol ProfileSelfDetailsViewControllerDelegate <NSObject>
...
@interface ProfileSelfDetailsViewController : UIViewController

@property (nonatomic, weak) id<ProfileSelfDetailsViewControllerDelegate> delegate;
