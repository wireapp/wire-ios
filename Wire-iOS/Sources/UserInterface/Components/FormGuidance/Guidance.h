...
@interface Guidance : NSObject <GuidanceProtocol>

@property (nonatomic, copy) NSString *title;
/// The additional explanation/description message
@property (nonatomic, copy) NSString *explanation;
@property (nonatomic, assign) GuidanceType guidanceType;
