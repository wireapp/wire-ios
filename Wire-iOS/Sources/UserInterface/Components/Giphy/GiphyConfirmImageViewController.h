...
@class GiphySearchResultsController;

@interface GiphyConfirmImageViewController : UIViewController <GiphyCollectionViewControllerDelegate>

@property (nonatomic, weak) GiphySearchResultsController *giphySearchResultsController;
