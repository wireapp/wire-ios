...
FOUNDATION_EXTERN NSString *const ZetaErrorDomain;
FOUNDATION_EXTERN NSString *const ZetaValidationGuidanceKey;


typedef enum ZetaErrorCode_e : NSInteger {
    ZetaUnspecifiedError = 0,
    ZetaValidationError,
} ZetaErrorCode;


@interface NSError (Zeta)
